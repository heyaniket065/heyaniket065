...
export function Cursor() {
  ...
  return (
    <div ref={dot} aria-hidden className="pointer-events-none fixed left-0 top-0 z-[100]">
      <div
        className="flex items-center justify-center rounded-full border border-ink/40 bg-ink/5 backdrop-blur-[1px] transition-[width,height,background-color] duration-300 ease-[cubic-bezier(0.16,1,0.3,1)]"
